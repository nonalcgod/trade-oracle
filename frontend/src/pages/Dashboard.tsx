 ...
 *
 * Original App.tsx content moved to a separate Dashboard page component
 * to enable routing for ScalperPro
 */
        ...
        <header className="mb-8">
          <div className="flex flex-wrap items-start justify-between gap-4 md:gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6">
              ...
              <Link
                to="/scalper"
                className="flex items-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-xl font-semibold transition transform hover:scale-105 active:scale-95 shadow-md"
              >
                <Zap size={18} />
